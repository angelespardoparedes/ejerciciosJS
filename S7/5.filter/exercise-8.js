...
// Agregar un evento de escucha al botón para llamar a la función de filtrado cuando se haga clic
document.getElementById('filterButton').addEventListener('click', filterStreamers);